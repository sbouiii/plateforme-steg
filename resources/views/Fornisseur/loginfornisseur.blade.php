...
<div class="container">
    <div class="frame">
        ...
        <div>
            <form class="form-signin" action="{{ route('supplier.login') }}" method="POST">
...
@endif
            ...
            <form class="form-signup" action="{{ route('fornisseur.register') }}" method="POST">
    @csrf
    <label for="full_name">Full name</label>
    <input class="form-styling" type="text" name="full_name" placeholder="Enter your full name" required />

    <label for="email">Email</label>
    <input class="form-styling" type="email" name="email" placeholder="Enter your email" required />

    <label for="phone_number">Enter Phone Number</label>
    <input class="form-styling" type="text" name="phone_number" placeholder="Enter your phone number" required />
